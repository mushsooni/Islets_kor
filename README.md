...
(게임 폴더: 스팀 라이브러리 - 게임 우클릭 - 관리 - 로컬 파일 탐색)
2. (선택) `islets.exe_patcher.cmd` 실행
3. `Options` - `GAMEPLAY` - `LANGUAGE` - `한국어`로 변경

### 문의, 제보
인디게임 갤러리 "[한글패치] Islets"  
https://gall.dcinside.com/indiegame/153577  
깃허브 이슈  
https://github.com/mushsooni/Islets_kor/issues

### 게임 원본 빌드
9546181 (Patch 1.003)  
https://steamdb.info/depot/1669421/history/?changeid=M:6320121424922803719


### 패치 제작
버섯순이  
Snowyegret(v1.2 기술지원)

### 업데이트 내역
2024-08-15 [v1.0] 최초 공개  
2025-09-02 배포 링크 변경 (구글 드라이브 → 깃허브 리포지토리)  
2026-03-10 [v1.1] 번역 개선, 폰트 교체  
2026-03-10 [v1.2] 하드코딩 텍스트 번역, 스파인 이미지 번역

### 사용된 폰트

**Averia Sans Libre** (AveriaSansLibre-Bold)  
Copyright (c) 2011, Dan Sayers (i@iotic.com)  
https://fonts.google.com/specimen/Averia+Sans+Libre/license
...
**온글잎 뿌까**  
Designed by Gae*** in 2022. Published by Ownglyph  
https://www.ownglyph.com/trial/7e42cde9-1ff4-4df8-a88a-a44aec628c42

**온글잎 애옹글**  
Designed by LEE*** in 2022. Published by Ownglyph  
https://www.ownglyph.com/trial/490f0237-e9dd-436b-83a0-38893ae7e87f
...
https://help.naver.com/service/30016/contents/18088
